...
{
    /// <summary>
    /// Snapshot based repository base implementation.
    /// </summary>
    public abstract class Repository<TAggregateRoot, TAggregateRootId> :
        ...
        IPersistableRepository where TAggregateRoot : Entity<TAggregateRootId>, IAggregateRoot<TAggregateRootId>
    {
